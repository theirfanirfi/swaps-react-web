    ...
    return (
      <div className="post-content">
        ...
        <div className="post-container">
          <img src={Connection.getProfileImageForUsers(this.props.status.profile_image)} alt="user" className="profile-photo-md pull-left" />
          <div className="post-detail">
            <div className="user-info">
              <h5><Link to={"/profile/"} className="profile-link">{this.props.status.name}</Link>{this.tagUsers()}</h5>
