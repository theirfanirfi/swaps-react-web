...
//   });
	...
	render(){
        ...
        <span>
        <button style={{marginRight:4}} class="btn btn-danger pull-right" onClick={() => this.decline()}>{this.state.decline}</button>
        <button style={{marginRight:4}} class="btn btn-success pull-right" onClick={() => this.approve()}>{this.state.approve}</button>
        </span>
        </p>
